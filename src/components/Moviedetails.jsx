...
const Moviedetails = () => {
  ...
  return info ? (
    ...
    >
          ...
          <span className=" rounded-full bg-yellow-600 text-white w-[5vh] h-[5vh] flex justify-center items-center font-semibold">
           ...
           <h1 className="font-semibold text-xl italic text-white">
            {info.detail.tagline }
             ...
             <h1 className="text-xl font-semibold mt-5 mb-5">
              Movie Translations : 
             <p className="font-normal mb-10  text-sm"> {info.translations.join(" ")} </p>
             </h1>


              <Link className="font-semibold text-lg rounded-lg py-5 px-10 text-white bg-[#6556CD]" to={`${pathname}/trailer`}> <i className="text-xl mr-2 ri-play-fill"> </i> Play Trailer</Link>
          ...
          {info.watchproviders && info.watchproviders.flatrate && (
            <div className="flex gap-x-10 items-center py-5 text-white">
              ...
              {info.watchproviders.flatrate.map((w , i) => (
                <img title={w.provider_name}  key={i}
     ...
     <h1 className="font-bold text-2xl text-white">Recommendation & Similar Stuff</h1>
